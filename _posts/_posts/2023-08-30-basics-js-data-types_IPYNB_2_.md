...
var obj = {
    Name: "Soni Dhenuva",
    Age: 14,
    currentClasses: ["Math 3a", "Spanish 3", "ENS 1", "CompSci (CSSE)", "Biology"],
    hobbies: ["Reading", "Crafting", "Writing", "Designing 3D Models", "Coding", "Neflex", "Sleeping"],
    musicArtists: ["Taylor Swift", "Arctic Monkeys", "Maneskin"],
    favoriteMovies: ["All Marvel Movies", "Rush Hour", "Transformers", "James Bond", "2012"],
}


console.log(obj);
// Chaning 'Name' to Manu Dhenuva"
obj.Name = "Manu Dhenuva"
console.log(obj.Name);
// Adding 'Sophia Isella' to musicArtists
obj.musicArtists.push("Sophia Isella");
console.log(obj.musicArtists);
// "Removing '2012' from favoriteMovies
obj.favoriteMovies.pop("2012");
console.log(obj.favoriteMovies);
//Adding new key-value called 'siblings' and stored the value 'Manu'
obj["siblings"] = "Manu";
console.log(obj.siblings)
// Consoling whole thing
console.log(obj);

var num1 = 30
var num2 = 5.3
var num3 = 20.865456787654
console.log("num1 * num2: ")
console.log(num1*num2);
console.log("num1 / num2: ")
console.log(num1/num2);
console.log("Rounding num3")
console.log(Math.round(num3));
console.log("Round 3 digits (num1 / num2)")
console.log((num1 / num2).toFixed(3))

console.log(typeof obj.Name)
console.log(typeof obj.Age)
console.log(typeof obj.favoriteMovies)
